...
# with command line options: ZMM_7TeV.cfi -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,L1Reco -n 10 --geometry DB --conditions auto:startup --customise Geometry/GGeometry/customise_Ggeom37X.py --relval 18000,200 --datatier GEN-SIM-DIGI-RAW-HLTDEBUG --eventcontent FEVTDEBUGHLT --fileout file:raw.root
