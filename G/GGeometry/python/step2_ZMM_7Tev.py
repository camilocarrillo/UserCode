...
# with command line options: step2 -s RAW2DIGI,L1Reco,RECO,ALCA:MuAlCalIsolatedMu+DtCalib,VALIDATION,DQM --datatier GEN-SIM-RECO --eventcontent RECOSIM --geometry DB --conditions auto:startup -n 100 --customise Geometry/GGeometry/customise_Ggeom37X.py --fileout file:reco.root --filein file:raw.root
...
def customise(process):
    process.GlobalTag.toGet = cms.VPSet(
        ...
        cms.PSet(record = cms.string("GRecoGeometryRcd"),
                 tag = cms.string("GRECO_Geometry_Tag38YV0"),
                 connect = cms.untracked.string("frontier://FrontierProd/CMS_COND_34X_GEOMETRY")
                 ),
