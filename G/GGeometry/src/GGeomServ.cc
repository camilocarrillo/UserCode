...
GGeomServ::GGeomServ::GGeomServ( const GDetId& id )
  : _id( &id ),
    _n( "" ),
    _sn( "" ),
    _cn( "" ),
...
GGeomServ::GGeomServ() : _id(0), _n(""), _sn(""), _cn(""), _t (-99), _z(false), _a(false)
{} 
