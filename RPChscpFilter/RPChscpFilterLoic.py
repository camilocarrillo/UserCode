...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('rfio:/afs/cern.ch/user/q/querten/scratch0/10_12_14_HSCP_Skim/CMSSW_3_8_6/src/SUSYBSMAnalysis/HSCP/test/BuildHSCParticles/Data/HSCP.root')
