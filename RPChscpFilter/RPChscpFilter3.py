...
#   fileNames = cms.untracked.vstring('/store/data/Run2010B/Mu/RECO/PromptReco-v2/000/146/804/5AF410C9-F8CA-DF11-8486-0030487D05B0.root')
    fileNames = cms.untracked.vstring('file:/tmp/carrillo/rehscp_Mu_Run2010B-PromptReco-v2_RECO.root')
)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/carrillo/rerehscp_Mu_Run2010B-PromptReco-v2_RECO.root')
)
