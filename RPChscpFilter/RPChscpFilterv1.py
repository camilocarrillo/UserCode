...
process = cms.Process("ReSelRPChscpEventsv1")
...
#  tracks = cms.untracked.string('standAloneSETMuons'), doesn't work
   ...
   rootFileName = cms.untracked.string('/tmp/carrillo/control_Mu_Run2010B-PromptReco-v2_RECO_HLT_Mu15_v1_JSON.root'),
...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring('file:/tmp/carrillo/Mu_Run2010B-PromptReco-v2_RECO_HLT_Mu15_v1_JSON.root')
)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/carrillo/reMu_Run2010B-PromptReco-v2_RECO_HLT_Mu15_v1_JSON.root')
)
