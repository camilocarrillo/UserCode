...
#    outputCommands = process.RAWSIMEventContent.outputCommands,
    fileName = cms.untracked.string('/tmp/carrillo/fromgen2.root'),
...
# Other statements
process.simMuonCSCDigis.InputCollection = 'MuonCSCHits'
process.simMuonRPCDigis.InputCollection = 'MuonRPCHits'
process.simMuonDTDigis.InputCollection = 'MuonDTHits'
