...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring('rfio:/castor/cern.ch/user/g/ggeorge/mileva/reco_oldCls/DYToMuMu_M60_RECO_Eta16_oldCLS_4.root')
)
...
process.p = cms.Path(process.L1Filter*process.rpcPointProducer*process.museg)
