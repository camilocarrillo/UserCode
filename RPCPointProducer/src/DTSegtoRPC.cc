	...
	if(DTSegmentCounter[DTId] == 1 && DTId.station()==4){
	  ...
	  if(segment->dimension()==2){
		...
		if(cosAng>MinCosAng){
		  ...
		  //rollstoreDT[DTStationIndex(0,dtWheel,dtSector,dtStation)];//Station should be always 4
