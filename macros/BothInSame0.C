...
TFile * theFileOut = new TFile("BothInOne.root","RECREATE");

std::cout<<"Reading files"<<std::endl;
TH1F * thehisto1 = (TH1F*) (theFile1->Get("GlobExpectedWheel_0"));
TH1F * thehisto2 = (TH1F*) (theFile2->Get("ExpW+0"));
TH1F * theOutput1 = new TH1F("TheOutPut1","Wheel 0",120,0.5,120.5);
TH1F * theOutput2 = new TH1F("TheOutPut2","Wheel 0",120,0.5,120.5);
...
TCanvas *Ca1 = new TCanvas("Ca1","Wheel_0",800,600);
