...
particleBeta[1] = (TH1F*) (theFile1->Get("hscpValidator/particleBeta"));mass[1]=800;  color[1]=1; 
particleBeta[2] = (TH1F*) (theFile2->Get("hscpValidator/particleBeta"));mass[2]=800;  color[2]=9; 
