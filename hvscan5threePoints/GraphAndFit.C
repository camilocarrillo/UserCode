...
void GraphAndFit(){
  ...
  efftxt9000.open("9000/effW2far.txt");
  efftxt9100.open("9100/effW2far.txt");
  efftxt9200.open("9200/effW2far.txt");
  hvscaninfo.open("outputW2far.txt");
  ...
  TH1F * EffBarrel = new TH1F ("EffBarrel","Efficiency Distribution For W2far",40,0.5,100.5);

  TH1F * WPBarrel = new TH1F ("WPBarrel","HV Distribution for W2far",40,8.5,9.5);

  TH1F * EffGlob = new TH1F ("GlobEfficiencyWheel_W2far","Efficiency W2far",105,0.5,105.5); //101 near
  //TH1F EffGlob = new TH1F ("GlobEfficiencyWheel_W2far","Efficiency W2far",105,0.5,105.5);  //105 far
  ...
  C1->Clear();
  EffBarrel->SaveAs("effDistroW2far.root");
  EffBarrel->GetXaxis()->SetTitle("%"); EffBarrel->Draw(); C1->SaveAs("effDistroW2far.png");

  C1->Clear();
  WPBarrel->SaveAs("wpW2far.root");
  WPBarrel->GetXaxis()->SetTitle("knee(V)"); WPBarrel->Draw(); C1->SaveAs("wpW2far.png");
  ...
  EffGlob->SaveAs("effGlobW2far.root");

  C1->SaveAs("effGlobCaW2far.root");
  C1->SaveAs("effGlobW2far.png");
